...
def DBCIRCUIT(carga,view):
    ...
    for i in range(len(carga)):
        ...
        if view==1:
            ...
            print("Id [",i+1,"] View = 1 DBCUIRCUIT(CARGA,1)") 
    ...
    print(tabulate(dbcircuit, headers=["Id","AWG/KCM","1F/2H", "2F/3H","3F/3H","3F/4H", "60", "75", "90","%Vd/1F", "%Vd/2F","%Vd/3F","%Vd/3F","Nc", "In", "60", "75", "90", "Op", "ITM"], tablefmt='psql'))
